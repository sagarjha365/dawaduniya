...
const AddProductPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (brandName && productName && productDescription && productPrice && selectedCategory && productImage) {
      try {
      ...
      <div className="form-container">
        ...
        <form onSubmit={handleSubmit}>
          <div>
            ...
            <input type="text" id="brandName" value={brandName} onChange={handleBrandNameChange} />
          </div>
          <div>
          ...
          <div>
            ...
            <select id="category" value={selectedCategory} onChange={handleCategoryChange}>
              {categories.map((category) => (
                <option key={category.categoryName} className='custom-option' value={category.categoryName}>
          ...
          <div>
            ...
            <input type="file" id="uploadProductImage" style={{ display: 'none' }} onChange={handleImageChange} />
          </div>
